...
public static class OsmImporter
{
    ...
    public static string NameKey(string name)
    {
        ...
        var words = cleaned.Split(' ', StringSplitOptions.RemoveEmptyEntries)
            // Родовые слова выбрасываем: улиц («улица Ленина» ↔ ГАР «Ленина») и типов
            // населённых пунктов — сопоставляемое имя «д. Долгий Остров» из ГАР должно
            // давать тот же ключ, что чистое OSM-имя «Долгий Остров» (21-01-04: из-за
            // типов геокодер промахивался по всем сёлам и деревням).
            .Where(w => w is not ("улица" or "переулок" or "проспект" or "шоссе" or "бульвар"
                        ...
                        // …и их сокращения: канонические имена ГАР всегда с типом
                        // («ул. Ленина»), и без этого ключ «ленина ул» не совпадал
                        // с OSM-ключом «ленина» — улицы не геокодировались вовсе.
                        or "ул" or "пер" or "пр" or "прд" or "пркт" or "прт" or "кт"
                        or "ш" or "наб" or "бр" or "б" or "р" or "пл" or "туп" or "лн" or "им"
                        or "г" or "город" or "д" or "дер" or "деревня" or "с" or "село"
                        or "п" or "пос" or "поселок" or "пгт" or "рп" or "сп" or "х" or "хутор"
                        or "аул" or "станица" or "тер" or "снт" or "днп" or "тсн" or "кп"))
            .ToArray();
