...
flowchart LR
    ...
    B -->|"output/&lt;термин&gt;/&lt;ГГГГММ&gt;/&lt;бланк&gt;.html"| C[✂️ ParseHTML<br>HTML → текст]
...
sequenceDiagram
    ...
    loop Для каждого термина 🔤
        loop Для каждого месяца 📅 (PeriodStart → PeriodEnd)
            ...
            App->>App: 💾 сохраняет output/термин/ГГГГММ/‹типографский номер бланка›.html<br>(существующие — пропуск ⏭️)
        end
    end
```
